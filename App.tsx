      ...
      <footer className="relative z-10 border-t border-white/5 py-12 bg-[#020205]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          ...
          <div className="flex gap-6 md:gap-8 order-2 md:order-3">
            ...
            <a href="https://farcaster.xyz/miniapps/83hgtZau7TNB/empowertours" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#00f3ff] transition-colors uppercase text-xs tracking-widest p-2">Farcaster</a>
          </div>
        </div>
      </footer>
